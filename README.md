...
| [**OpenSSL**](interop/main.zig) | [![interop](https://github.com/zoxy-io/zssl/actions/workflows/interop.yml/badge.svg)](https://github.com/zoxy-io/zssl/actions/workflows/interop.yml) | Four legs against a real `openssl` binary |
...
than they run: BoGo never ran 6918 of its cases, tlsfuzzer runs 21
